...
class DTUDatasetPixelNerf(Dataset):
    def __init__(self, args: Dict[str, Any], split: str, scenes: str='', **kwargs):
        ...
        if self.args.dtu_split_type == 'pixelnerf': # default split for image ids
            ...
            split_indices = {'test': test_idx, 'train': train_idx} # [1, 2, 9, 10, 11, 12, 14, 15, 23, 24, 26, 27, 29, 30, 31, 32, 33, 34, 35, 41, 42, 43, 45, 46, 47]
