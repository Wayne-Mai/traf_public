...
class RaySamplingStrategy:
    ...
    def __init__(self, opt: Dict[str, Any], data_dict: Dict[str, Any], device: torch.device):
        ...
        self.all_possible_pixels = self.get_all_samples(data_dict)  # [HW, 2], from [0,0] to [503,377]
    ...
    def __call__(self, nbr_pixels: int, sample_in_center: bool=False, 
        ...
        nbr_pixels_per_img = nbr_pixels // nbr_images # 2048 is just random sampled rays, defined in config file
        nbr_rand_pixels_per_img = nbr_pixels // nbr_images # 682 for 3 sparse views
        ...
        if sample_in_center:
            ...
            random_pixels = self.all_possible_pixels[random_rays_idx]  # (n_r, 2), pixels per image
        ...
        return random_rays # ray index, [2048/n_images, 1], the same for all threee images
        # todo should we consider different images sample different pixel indices ??
